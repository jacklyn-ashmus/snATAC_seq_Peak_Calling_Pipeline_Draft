...
IN_PEAK_DIR=/nfs/lab/projects/islet_multiomics_stress_CoCl2/pipeline/peak_calls/fixed_peaks/treatment_celltype/bare_peaks/
INTERMED_DIR1=/nfs/lab/projects/islet_multiomics_stress_CoCl2/pipeline/peak_calls/fixed_peaks/merged_to_celltype/REDO/peaks/intermed/
INTERMED_DIR2=/nfs/lab/projects/islet_multiomics_stress_CoCl2/pipeline/peak_calls/fixed_peaks/merged_to_celltype/REDO/peaks/intermed/
OUT_PEAK_DIR=/nfs/lab/projects/islet_multiomics_stress_CoCl2/pipeline/peak_calls/fixed_peaks/merged_to_celltype/REDO/peaks/
...
for cell in ${CELLTYPES[@]}; do 
    ...
    (
        # echo "$cell"
            ...
            cocl2_file="${IN_PEAK_DIR}CoCl2__${cell}.fixed_peaks.400bp.bare.bed"
            unt_file="${IN_PEAK_DIR}Unt__${cell}.fixed_peaks.400bp.bare.bed"
            ...
            merged_file="${OUT_PEAK_DIR}${cell}.peaks_merged_from_fixed_400bp_treatment_celltype.merged.peak.bed"
            merged_bare_file="${OUT_PEAK_DIR}${cell}.peaks_merged_from_fixed_400bp_treatment_celltype.merged.peak.bare.bed"
            echo "$cell unt cut"      
